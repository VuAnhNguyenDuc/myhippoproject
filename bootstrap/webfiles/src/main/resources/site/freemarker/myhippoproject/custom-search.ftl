...
<#--
&lt;#&ndash; @ftlvariable name="query" type="java.lang.String" &ndash;&gt;
&lt;#&ndash; @ftlvariable name="pageable" type="org.onehippo.cms7.essentials.components.paging.Pageable" &ndash;&gt;
<#if pageable??>
  <#if pageable.total == 0>
